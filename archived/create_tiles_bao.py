...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=224,
        help="The stride in x and y (default 250)",
    )
    parser.add_argument(
        "--patch_size",
        type=int,
        default=224,
        help="Patch size (default 1000)",
    )
    parser.add_argument(
        "--output_size",
        type=int,
...
def process_slide(args: PatchConfig, slide_path: str, patch_coords: list):
    ...
    h5_path = f"{args.patch_folder}/coords/{get_slide_id(slide_path)}.h5"
...
def main():
    ...
    ##
    all_slides = [
        "/n/data2/hms/dbmi/kyu/lab/datasets/tcgaGBM/dxImages/svs/aa5d02db-efe2-4591-806a-906bea7f6aa3/TCGA-41-3393-01Z-00-DX1.f3a44b0d-dad5-4e0a-ac85-fe2ac191ee47.svs",
        "/n/data2/hms/dbmi/kyu/lab/datasets/tcgaGBM/dxImages/svs/be0beca3-4962-4637-9e7b-762528e2b95f/TCGA-19-1385-01Z-00-DX1.08e05d7e-2687-4bf3-8955-2ed4ccb62567.svs",
        "/n/data2/hms/dbmi/kyu/lab/datasets/tcgaGBM/dxImages/svs/aa4028b4-f102-499b-a362-ee6ef4448767/TCGA-41-3392-01Z-00-DX1.2d3dba82-f1cb-4589-bad1-f27ca388049b.svs",
        "/n/data2/hms/dbmi/kyu/lab/datasets/tcgaGBM/dxImages/svs/4ca87855-fb6d-4aae-9490-a013e3e61201/TCGA-08-0386-01Z-00-DX1.F3BE4054-6C0D-4E04-B9F7-8662AADDC8DF.svs",
        "/n/data2/hms/dbmi/kyu/lab/datasets/tcgaGBM/dxImages/svs/586cf111-6321-4a7c-8e64-62f38d622031/TCGA-02-0289-01Z-00-DX2.4C3CD7F5-C51B-4818-8E7F-7AF0D7A46685.svs"
    ]
    ##
